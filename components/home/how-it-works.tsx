...
const steps: Step[] = [
  {
    ...
    label: "Upload PDF",
    description: "Simply drag and drop your PDF document and click to upload"
  },
  {
...
function HowItWorksSection() {
  return (
    <section className='relative overflow-hidden bg-gray-50 flex flex-col items-center space-y-4'>
      <div className='py-12 lg:py:24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          <h2 className='font-bold text-xl uppercase text-rose-500 mb-4'>HOW IT WORKS</h2>
          <h3 className='text-3xl font-bold max-w-2xl mx-auto'>Transform any PDF into an easy-to-digest summary in three simple steps</h3>
        </div>
...
function StepItem({icon, label, description} : Step) {
  return <div className='relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full'>
    <div className='flex flex-col gap-4 h-full'>
      ...
      <div className='flex flex-col flex-1 gap-1 justify-between items-center'>
